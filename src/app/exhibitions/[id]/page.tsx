            ...
            <div className="flex-1 min-w-0">
              ...
              {booth.keywords && booth.keywords.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-4">
                  {booth.keywords.map((keyword, idx) => (
                    <span
                      key={idx}
              ...
              {activeTab === 'about' && (
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                    {booth.theme && (
                      <div>
                        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Theme</p>
                        <p className="text-gray-900 mt-1 capitalize">{booth.theme}</p>
                      </div>
                    )}
                    {booth.layout && (
                      <div>
                        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Layout</p>
                        <p className="text-gray-900 mt-1 capitalize">{booth.layout}</p>
                      </div>
                    )}
                  </div>
                </div>
