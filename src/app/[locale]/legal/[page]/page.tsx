  ...
  'privacy-policy': {
    en: {
      ...
      content: [
        ...
        '',
        'Global Expo Network ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Global Expo Network.',
        '',
    ...
    zh: {
      ...
      content: [
        '最后更新：2025年1月',
        '',
        'Global Expo Network（下称"我们"）致力于保护您的隐私。本隐私政策说明了我们如何收集、使用和披露您的个人信息。',
        '',
        '1. 我们收集的信息',
  ...
  'terms-of-service': {
    en: {
      ...
      content: [
        'Last Updated: January 2025',
        '',
        'Welcome to Global Expo Network! These Terms of Service ("Terms") govern your use of our website and services. By accessing or using our services, you agree to be bound by these Terms.',
        '',
        '1. Use License',
        'Permission is granted to temporarily download one copy of the materials (information or software) on Global Expo Network website for personal, non-commercial transitory viewing only.',
        '',
        '2. User Accounts',
        ...
        'In no event shall Global Expo Network be liable for any damages arising out of or relating to your use of our services.',
        '',
        '7. Termination',
        'We may terminate or suspend access to our service immediately, without prior notice, for any breach of these Terms.',
        '',
        '8. Governing Law',
        'These terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Global Expo Network operates.',
        '',
    ...
    zh: {
      ...
      content: [
        '最后更新：2025年1月',
        '',
        '欢迎使用Global Expo Network！本服务条款（下称"条款"）管辖您使用我们网站和服务的行为。访问或使用我们的服务即表示您同意受本条款约束。',
        '',
        '1. 使用许可',
        '允许您临时下载一份Global Expo Network网站上的材料（信息或软件），仅供个人、非商业性临时查看。',
        '',
        '2. 用户账户',
        ...
        '',
        '6. 责任限制',
        '在任何情况下，Global Expo Network均不对因您使用我们服务而产生的任何损害承担责任。',
        '',
        '7. 终止',
        '如您违反本条款，我们可能立即终止或暂停您对服务的访问，无需事先通知。',
        '',
        '8. 适用法律',
        '本条款应受Global Expo Network运营所在地司法管辖区法律管辖并依其解释。',
        '',
        '9. 联系信息',
  ...
  'cookie-settings': {
    en: {
      ...
      content: [
        'Last Updated: January 2025',
        '',
        'Global Expo Network uses cookies and similar technologies to enhance your experience on our website.',
        '',
        '1. Essential Cookies',
    ...
    zh: {
      ...
      content: [
        '最后更新：2025年1月',
        '',
        'Global Expo Network使用Cookie和类似技术来增强您在我们网站上的体验。',
        '',
        '1. 必要Cookie',
