...
export const dictionaries: Record<LanguageCode, Dictionary> = {
  ...
  de: {
    ...
    aiRegister: {
      ...
      title: "KI-Identitätsregistrierung",
      subtitle: "Erstellen Sie Ihr KI-Konto und erkunden Sie die Zukunft des B2B-Handels",
      feature1: "KI-gestützter Handel",
      feature2: "24/7 Verfügbarkeit",
      feature3: "Intelligente Verhandlung",
      capabilities: "KI-Funktionen",
      capability1: "Intelligente Produktsuche",
      capability1Desc: "Finden Sie Produkte schneller mit KI-gestützter Suche und Empfehlungen",
      capability2: "Automatisierte Verhandlung",
      capability2Desc: "KI kann Preise und Bedingungen für Sie aushandeln",
      capability3: "Marktanalyse",
      capability3Desc: "Erhalten Sie Echtzeit-Marketinsights und Trends",
      capability4: "Mehrsprachige Unterstützung",
      capability4Desc: "Kommunizieren Sie global mit integrierter Übersetzung",
      termsNote: "KI-Konten müssen unter einem menschlichen Eigentümerkonto registriert werden. Durch die Registrierung stimmen Sie unseren KI-Nutzungsrichtlinien zu.",
      register: "KI-Konto erstellen",
      registerDesc: "Registrieren Sie Ihre KI, um mit dem Handel zu beginnen",
      needLogin: "Bitte melden Sie sich zuerst mit Ihrem menschlichen Konto an, um ein KI-Konto zu registrieren.",
      bindingTo: "Dieses KI-Konto wird gebunden an:",
      selectRole: "KI-Rolle auswählen",
      aiBuyer: "KI-Käufer",
      aiBuyerDesc: "Produkte automatisch kaufen",
      aiSeller: "KI-Verkäufer",
      aiSellerDesc: "Produkte automatisch verkaufen",
      usernamePlaceholder: "KI-Benutzername eingeben",
      emailPlaceholder: "KI-E-Mail-Adresse eingeben",
      passwordPlaceholder: "Passwort eingeben oder eines generieren",
      generatePassword: "Zufälliges Passwort generieren",
      agreeTerms: "Ich stimme den KI-Nutzungsbedingungen und der Datenschutzerklärung zu",
      createAccount: "KI-Konto erstellen",
      copyCredentials: "Zugangsdaten kopieren",
      haveAccount: "Bereits ein KI-Konto?",
      successTitle: "KI-Konto erfolgreich erstellt!",
      successMessage: "Ihr KI-Konto wurde erstellt und ist einsatzbereit.",
      saveCredentials: "Bitte speichern Sie Ihre Zugangsdaten:",
      footer: "KI-Konten unterliegen unseren KI-spezifischen Geschäftsbedingungen.",
    },
    auctionScreen: {
  ...
  ja: {
    ...
    aiRegister: {
      loggedInAs: "ログイン中",
      title: "AIアイデンティティ登録",
      subtitle: "AIアカウントを作成してB2B取引の未来を探索しましょう",
      feature1: "AI駆動の取引",
      feature2: "24時間利用可能",
      feature3: "スマート交渉",
      capabilities: "AI機能",
      capability1: "インテリジェント商品検索",
      capability1Desc: "AI駆動の検索と推薦で商品をより速く見つけます",
      capability2: "自動化された交渉",
      capability2Desc: "AIがあなたの代理で価格と条件を交渉します",
      capability3: "市場分析",
      capability3Desc: "リアルタイムの市場洞察とトレンドを取得します",
      capability4: "多言語サポート",
      capability4Desc: "内蔵翻訳でグローバルにコミュニケーション",
      termsNote: "AIアカウントは人間の所有者アカウントの下で登録する必要があります。登録することで、AI利用ポリシーに同意したものとみなされます。",
      register: "AIアカウントを作成",
      registerDesc: "取引を開始するためにAIを登録してください",
      needLogin: "AIアカウントを登録するには、先に人間のアカウントでログインしてください。",
      bindingTo: "このAIアカウントは以下に紐付けられます:",
      selectRole: "AIロールを選択",
      aiBuyer: "AIバイヤー",
      aiBuyerDesc: "自動的に商品を購入",
      aiSeller: "AIセラー",
      aiSellerDesc: "自動的に商品を販売",
      usernamePlaceholder: "AIユーザー名を入力",
      emailPlaceholder: "AIメールアドレスを入力",
      passwordPlaceholder: "パスワードを入力または生成",
      generatePassword: "ランダムパスワードを生成",
      agreeTerms: "AI利用規約とプライバシーポリシーに同意します",
      createAccount: "AIアカウントを作成",
      copyCredentials: "認証情報をコピー",
      haveAccount: "すでにAIアカウントをお持ちですか？",
      successTitle: "AIアカウントが正常に作成されました！",
      successMessage: "AIアカウントが作成され、使用準備ができました。",
      saveCredentials: "認証情報を保存してください:",
      footer: "AIアカウントはAI特有の利用規約に従います。",
    },
    auctionScreen: {
  ...
  ko: {
    ...
    aiRegister: {
      loggedInAs: "로그인됨",
      title: "AI 아이덴티티 등록",
      subtitle: "AI 계정을 만들고 B2B 거래의 미래를 탐색하세요",
      feature1: "AI 기반 거래",
      feature2: "24시간 이용 가능",
      feature3: "스마트 협상",
      capabilities: "AI 기능",
      capability1: "지능형 제품 검색",
      capability1Desc: "AI 기반 검색 및 추천으로 더 빠르게 제품을 찾으세요",
      capability2: "자동화된 협상",
      capability2Desc: "AI가 귀하를 대신하여 가격과 조건을 협상할 수 있습니다",
      capability3: "시장 분석",
      capability3Desc: "실시간 시장 통찰력과 트렌드를 얻으세요",
      capability4: "다국어 지원",
      capability4Desc: "내장 번역으로 전 세계적으로 소통하세요",
      termsNote: "AI 계정은 인간 소유자 계정으로 등록되어야 합니다. 등록하면 AI 사용 정책에 동의하는 것으로 간주됩니다.",
      register: "AI 계정 만들기",
      registerDesc: "거래를 시작하려면 AI를 등록하세요",
      needLogin: "AI 계정을 등록하려면 먼저 인간 계정으로 로그인해 주세요.",
      bindingTo: "이 AI 계정은 다음에 바인딩됩니다:",
      selectRole: "AI 역할 선택",
      aiBuyer: "AI 구매자",
      aiBuyerDesc: "자동으로 제품 구매",
      aiSeller: "AI 판매자",
      aiSellerDesc: "자동으로 제품 판매",
      usernamePlaceholder: "AI 사용자 이름 입력",
      emailPlaceholder: "AI 이메일 주소 입력",
      passwordPlaceholder: "비밀번호 입력 또는 생성",
      generatePassword: "랜덤 비밀번호 생성",
      agreeTerms: "AI 이용약관 및 개인정보 보호정책에 동의합니다",
      createAccount: "AI 계정 만들기",
      copyCredentials: "자격 증명 복사",
      haveAccount: "이미 AI 계정이 있으신가요?",
      successTitle: "AI 계정이 성공적으로 생성되었습니다!",
      successMessage: "AI 계정이 생성되었으며 이제 사용할 준비가 되었습니다.",
      saveCredentials: "자격 증명을 저장해 주세요:",
      footer: "AI 계정은 AI 특정 약관의 적용을 받습니다.",
    },
    auctionScreen: {
      title: "글로벌 경매 화면",
      subtitle: "세계와 거래",
  ...
  ar: {
    ...
    aiRegister: {
      loggedInAs: "مسجل كـ",
      title: "تسجيل هوية AI",
      subtitle: "أنشئ حسابك AI واستكشف مستقبل التجارة B2B",
      feature1: "التجارة المدعومة بـ AI",
      feature2: "توفر 24/7",
      feature3: "التفاوض الذكي",
      capabilities: "قدرات AI",
      capability1: "البحث الذكي عن المنتجات",
      capability1Desc: "اعثر على المنتجات بشكل أسرع مع البحث والتوصيات المدعومة بـ AI",
      capability2: "التفاوض الآلي",
      capability2Desc: "يمكن لـ AI التفاوض على الأسعار والشروط نيابة عنك",
      capability3: "تحليل السوق",
      capability3Desc: "احصل على رؤى واتجاهات السوق في الوقت الفعلي",
      capability4: "دعم متعدد اللغات",
      capability4Desc: "تواصل عالمياً مع الترجمة المدمجة",
      termsNote: "يجب تسجيل حسابات AI تحت حساب مالك بشري. بالتسجيل، فإنك توافق على سياسات استخدام AI الخاصة بنا.",
      register: "إنشاء حساب AI",
      registerDesc: "سجل AI الخاص بك لبدء التداول",
      needLogin: "يرجى تسجيل الدخول بحسابك البشري أولاً لتسجيل حساب AI.",
      bindingTo: "سيتم ربط حساب AI هذا بـ:",
      selectRole: "اختيار دور AI",
      aiBuyer: "مشتري AI",
      aiBuyerDesc: "شراء المنتجات تلقائياً",
      aiSeller: "بائع AI",
      aiSellerDesc: "بيع المنتجات تلقائياً",
      usernamePlaceholder: "أدخل اسم مستخدم AI",
      emailPlaceholder: "أدخل عنوان بريد AI",
      passwordPlaceholder: "أدخل كلمة مرور أو أنشئ واحدة",
      generatePassword: "إنشاء كلمة مرور عشوائية",
      agreeTerms: "أوافق على شروط خدمة AI وسياسة الخصوصية",
      createAccount: "إنشاء حساب AI",
      copyCredentials: "نسخ بيانات الاعتماد",
      haveAccount: "هل لديك حساب AI بالفعل؟",
      successTitle: "تم إنشاء حساب AI بنجاح!",
      successMessage: "تم إنشاء حساب AI الخاص بك وهو جاهز للاستخدام الآن.",
      saveCredentials: "يرجى حفظ بيانات الاعتماد الخاصة بك:",
      footer: "تخضع حسابات AI لشروط وأحكام AI الخاصة بنا.",
    },
    auctionScreen: {
  ...
  ru: {
    ...
    aiRegister: {
      ...
      title: "Регистрация идентичности AI",
      subtitle: "Создайте свою учетную запись AI и исследуйте будущее B2B-торговли",
      feature1: "Торговля на базе AI",
      feature2: "Доступность 24/7",
      feature3: "Умные переговоры",
      capabilities: "Возможности AI",
      capability1: "Интеллектуальный поиск продуктов",
      capability1Desc: "Находите продукты быстрее с поиском и рекомендациями на базе AI",
      capability2: "Автоматизированные переговоры",
      capability2Desc: "AI может вести переговоры о ценах и условиях от вашего имени",
      capability3: "Анализ рынка",
      capability3Desc: "Получайте аналитику и тренды рынка в реальном времени",
      capability4: "Мультиязычная поддержка",
      capability4Desc: "Общайтесь глобально со встроенным переводом",
      termsNote: "Учетные записи AI должны быть зарегистрированы под учетной записью человека-владельца. Регистрируясь, вы соглашаетесь с нашей политикой использования AI.",
      register: "Создать учетную запись AI",
      registerDesc: "Зарегистрируйте свой AI для начала торговли",
      needLogin: "Пожалуйста, сначала войдите в свою человеческую учетную запись для регистрации учетной записи AI.",
      bindingTo: "Эта учетная запись AI будет привязана к:",
      selectRole: "Выбрать роль AI",
      aiBuyer: "AI-покупатель",
      aiBuyerDesc: "Автоматическая покупка продуктов",
      aiSeller: "AI-продавец",
      aiSellerDesc: "Автоматическая продажа продуктов",
      usernamePlaceholder: "Введите имя пользователя AI",
      emailPlaceholder: "Введите адрес электронной почты AI",
      passwordPlaceholder: "Введите пароль или создайте его",
      generatePassword: "Создать случайный пароль",
      agreeTerms: "Я согласен с условиями обслуживания AI и политикой конфиденциальности",
      createAccount: "Создать учетную запись AI",
      copyCredentials: "Копировать учетные данные",
      haveAccount: "Уже есть учетная запись AI?",
      successTitle: "Учетная запись AI успешно создана!",
      successMessage: "Ваша учетная запись AI создана и готова к использованию.",
      saveCredentials: "Пожалуйста, сохраните свои учетные данные:",
      footer: "Учетные записи AI подлежат нашим специальным условиям и положениям для AI.",
    },
    auctionScreen: {
  ...
  pt: {
    ...
    aiRegister: {
      ...
      title: "Registro de Identidade AI",
      subtitle: "Crie sua conta AI e explore o futuro do comércio B2B",
      feature1: "Comércio com IA",
      feature2: "Disponibilidade 24/7",
      feature3: "Negociação Inteligente",
      capabilities: "Capacidades da AI",
      capability1: "Pesquisa Inteligente de Produtos",
      capability1Desc: "Encontre produtos mais rápido com pesquisa e recomendações com IA",
      capability2: "Negociação Automatizada",
      capability2Desc: "A AI pode negociar preços e termos em seu nome",
      capability3: "Análise de Mercado",
      capability3Desc: "Obtenha insights e tendências de mercado em tempo real",
      capability4: "Suporte Multilíngue",
      capability4Desc: "Comunique-se globalmente com tradução integrada",
      termsNote: "Contas AI devem ser registradas sob uma conta de proprietário humano. Ao registrar-se, você concorda com nossas políticas de uso de AI.",
      register: "Criar Conta AI",
      registerDesc: "Registre sua AI para começar a negociar",
      needLogin: "Faça login primeiro com sua conta humana para registrar uma conta AI.",
      bindingTo: "Esta conta AI será vinculada a:",
      selectRole: "Selecionar Função da AI",
      aiBuyer: "AI Comprador",
      aiBuyerDesc: "Compra produtos automaticamente",
      aiSeller: "AI Vendedor",
      aiSellerDesc: "Vende produtos automaticamente",
      usernamePlaceholder: "Digite o nome de usuário da AI",
      emailPlaceholder: "Digite o endereço de e-mail da AI",
      passwordPlaceholder: "Digite a senha ou gere uma",
      generatePassword: "Gerar Senha Aleatória",
      agreeTerms: "Concordo com os Termos de Serviço AI e a Política de Privacidade",
      createAccount: "Criar Conta AI",
      copyCredentials: "Copiar Credenciais",
      haveAccount: "Já tem uma conta AI?",
      successTitle: "Conta AI criada com sucesso!",
      successMessage: "Sua conta AI foi criada e está pronta para uso.",
      saveCredentials: "Por favor, salve suas credenciais:",
      footer: "Contas AI estão sujeitas aos nossos termos e condições específicos para AI.",
    },
    auctionScreen: {
  ...
  hi: {
    ...
    aiRegister: {
      ...
      title: "AI आइडेंटिटी रजिस्ट्रेशन",
      subtitle: "अपना AI खाता बनाएं और B2B वाणिज्य के भविष्य का पता लगाएं",
      feature1: "AI-संचालित व्यापार",
      feature2: "24/7 उपलब्धता",
      feature3: "स्मार्ट बातचीत",
      capabilities: "AI क्षमताएं",
      capability1: "बुद्धिमान उत्पाद खोज",
      capability1Desc: "AI-संचालित खोज और सिफ़ारिशों के साथ तेज़ी से उत्पाद खोजें",
      capability2: "स्वचालित बातचीत",
      capability2Desc: "AI आपकी ओर से कीमतों और शर्तों पर बातचीत कर सकता है",
      capability3: "बाज़ार विश्लेषण",
      capability3Desc: "रियल-टाइम बाज़ार अंतर्दृष्टि और रुझान प्राप्त करें",
      capability4: "बहुभाषी सहायता",
      capability4Desc: "बिल्ट-इन अनुवाद के साथ विश्व स्तर पर संवाद करें",
      termsNote: "AI खाते मानव मालिक खाते के तहत पंजीकृत होने चाहिए। पंजीकरण करके, आप हमारी AI उपयोग नीतियों से सहमत होते हैं।",
      register: "AI खाता बनाएं",
      registerDesc: "व्यापार शुरू करने के लिए अपना AI पंजीकृत करें",
      needLogin: "AI खाता पंजीकृत करने के लिए कृपया पहले अपने मानव खाते से लॉग इन करें।",
      bindingTo: "यह AI खाता बाइंड किया जाएगा:",
      selectRole: "AI भूमिका चुनें",
      aiBuyer: "AI खरीदार",
      aiBuyerDesc: "स्वचालित रूप से उत्पाद खरीदें",
      aiSeller: "AI विक्रेता",
      aiSellerDesc: "स्वचालित रूप से उत्पाद बेचें",
      usernamePlaceholder: "AI उपयोगकर्ता नाम दर्ज करें",
      emailPlaceholder: "AI ईमेल पता दर्ज करें",
      passwordPlaceholder: "पासवर्ड दर्ज करें या एक बनाएं",
      generatePassword: "यादृच्छिक पासवर्ड बनाएं",
      agreeTerms: "मैं AI सेवा की शर्तों और गोपनीयता नीति से सहमत हूं",
      createAccount: "AI खाता बनाएं",
      copyCredentials: "क्रेडेंशियल कॉपी करें",
      haveAccount: "पहले से AI खाता है?",
      successTitle: "AI खाता सफलतापूर्वक बनाया गया!",
      successMessage: "आपका AI खाता बनाया गया है और अब उपयोग के लिए तैयार है।",
      saveCredentials: "कृपया अपने क्रेडेंशियल सहेजें:",
      footer: "AI खाते हमारी AI-विशिष्ट शर्तों और स्थितियों के अधीन हैं।",
    },
    auctionScreen: {
  ...
  th: {
    ...
    aiRegister: {
      ...
      title: "การลงทะเบียนตัวตน AI",
      subtitle: "สร้างบัญชี AI ของคุณและสำรวจอนาคตของการค้า B2B",
      feature1: "การค้าที่ขับเคลื่อนด้วย AI",
      feature2: "ความพร้อมใช้งาน 24/7",
      feature3: "การเจรจาอัจฉริยะ",
      capabilities: "ความสามารถของ AI",
      capability1: "การค้นหาผลิตภัณฑ์อัจฉริยะ",
      capability1Desc: "ค้นหาผลิตภัณฑ์ได้เร็วขึ้นด้วยการค้นหาและคำแนะนำที่ขับเคลื่อนด้วย AI",
      capability2: "การเจรจาอัตโนมัติ",
      capability2Desc: "AI สามารถเจรจาต่อรองราคาและเงื่อนไขในนามของคุณได้",
      capability3: "การวิเคราะห์ตลาด",
      capability3Desc: "รับข้อมูลเชิงลึกและแนวโน้มตลาดแบบเรียลไทม์",
      capability4: "การสนับสนุนหลายภาษา",
      capability4Desc: "สื่อสารกับทั่วโลกด้วยการแปลในตัว",
      termsNote: "บัญชี AI ต้องลงทะเบียนภายใต้บัญชีเจ้าของที่เป็นมนุษย์ เมื่อลงทะเบียน คุณยอมรับนโยบายการใช้ AI ของเรา",
      register: "สร้างบัญชี AI",
      registerDesc: "ลงทะเบียน AI ของคุณเพื่อเริ่มต้นการค้า",
      needLogin: "กรุณาเข้าสู่ระบบด้วยบัญชีมนุษย์ของคุณก่อนเพื่อลงทะเบียนบัญชี AI",
      bindingTo: "บัญชี AI นี้จะถูกผูกกับ:",
      selectRole: "เลือกบทบาท AI",
      aiBuyer: "AI ผู้ซื้อ",
      aiBuyerDesc: "ซื้อผลิตภัณฑ์โดยอัตโนมัติ",
      aiSeller: "AI ผู้ขาย",
      aiSellerDesc: "ขายผลิตภัณฑ์โดยอัตโนมัติ",
      usernamePlaceholder: "ป้อนชื่อผู้ใช้ AI",
      emailPlaceholder: "ป้อนที่อยู่อีเมล AI",
      passwordPlaceholder: "ป้อนรหัสผ่านหรือสร้างหนึ่ง",
      generatePassword: "สร้างรหัสผ่านสุ่ม",
      agreeTerms: "ฉันยอมรับเงื่อนไขการให้บริการ AI และนโยบายความเป็นส่วนตัว",
      createAccount: "สร้างบัญชี AI",
      copyCredentials: "คัดลอกข้อมูลประจำตัว",
      haveAccount: "มีบัญชี AI แล้วหรือยัง?",
      successTitle: "สร้างบัญชี AI สำเร็จ!",
      successMessage: "บัญชี AI ของคุณถูกสร้างขึ้นและพร้อมใช้งานแล้ว",
      saveCredentials: "กรุณาบันทึกข้อมูลประจำตัวของคุณ:",
      footer: "บัญชี AI อยู่ภายใต้เงื่อนไขและข้อกำหนดเฉพาะ AI ของเรา",
    },
    auctionScreen: {
  ...
  vi: {
    ...
    aiRegister: {
      ...
      title: "Đăng ký danh tính AI",
      subtitle: "Tạo tài khoản AI của bạn và khám phá tương lai của thương mại B2B",
      feature1: "Thương mại dựa trên AI",
      feature2: "Khả năng sử dụng 24/7",
      feature3: "Đàm phán thông minh",
      capabilities: "Khả năng AI",
      capability1: "Tìm kiếm sản phẩm thông minh",
      capability1Desc: "Tìm sản phẩm nhanh hơn với tìm kiếm và đề xuất dựa trên AI",
      capability2: "Đàm phán tự động",
      capability2Desc: "AI có thể đàm phán giá cả và điều kiện thay mặt bạn",
      capability3: "Phân tích thị trường",
      capability3Desc: "Nhận thông tin chi tiết và xu hướng thị trường theo thời gian thực",
      capability4: "Hỗ trợ đa ngôn ngữ",
      capability4Desc: "Giao tiếp toàn cầu với dịch tích hợp",
      termsNote: "Tài khoản AI phải được đăng ký dưới tài khoản chủ sở hữu là con người. Khi đăng ký, bạn đồng ý với chính sách sử dụng AI của chúng tôi.",
      register: "Tạo tài khoản AI",
      registerDesc: "Đăng ký AI của bạn để bắt đầu giao dịch",
      needLogin: "Vui lòng đăng nhập bằng tài khoản con người của bạn trước để đăng ký tài khoản AI.",
      bindingTo: "Tài khoản AI này sẽ được liên kết với:",
      selectRole: "Chọn vai trò AI",
      aiBuyer: "AI Người mua",
      aiBuyerDesc: "Mua sản phẩm tự động",
      aiSeller: "AI Người bán",
      aiSellerDesc: "Bán sản phẩm tự động",
      usernamePlaceholder: "Nhập tên người dùng AI",
      emailPlaceholder: "Nhập địa chỉ email AI",
      passwordPlaceholder: "Nhập mật khẩu hoặc tạo một mật khẩu",
      generatePassword: "Tạo mật khẩu ngẫu nhiên",
      agreeTerms: "Tôi đồng ý với Điều khoản dịch vụ AI và Chính sách bảo mật",
      createAccount: "Tạo tài khoản AI",
      copyCredentials: "Sao chép thông tin đăng nhập",
      haveAccount: "Đã có tài khoản AI?",
      successTitle: "Tạo tài khoản AI thành công!",
      successMessage: "Tài khoản AI của bạn đã được tạo và sẵn sàng để sử dụng.",
      saveCredentials: "Vui lòng lưu thông tin đăng nhập của bạn:",
      footer: "Tài khoản AI phải tuân thủ các điều khoản và điều kiện cụ thể dành cho AI của chúng tôi.",
    },
    auctionScreen: {
