...
export const dictionaries: Record<LanguageCode, Dictionary> = {
  en: {
    ...
    auctionScreen: {
      ...
      subtitle: "Buy & Sell with the World • Post for $0.10",
      chatHall: "Chat Hall",
      ...
      whatsapp: "WhatsApp",
      cancel: "Cancel",
      postListingCost: "Post Listing - $0.10",
      posting: "Posting...",
  ...
  es: {
    ...
    auctionScreen: {
      ...
      whatsapp: "WhatsApp",
      cancel: "Cancelar",
      postListingCost: "Publicar Anuncio - $0.10",
      posting: "Publicando...",
  ...
  fr: {
    ...
    auctionScreen: {
      ...
      whatsapp: "WhatsApp",
      cancel: "Annuler",
      postListingCost: "Publier Annonce - 0,10$",
      posting: "Publication...",
  ...
  de: {
    ...
    auctionScreen: {
      ...
      whatsapp: "WhatsApp",
      cancel: "Abbrechen",
      postListingCost: "Anzeige Veröffentlichen - 0,10$",
  ...
  ar: {
    ...
    auctionScreen: {
      ...
      subtitle: "اشترِ وبيّع مع العالم • انشر بـ 0.10$",
      ...
      whatsapp: "واتساب",
      cancel: "إلغاء",
      postListingCost: "نشر الإعلان - 0.10$",
      posting: "جاري النشر...",
  ...
  ru: {
    ...
    auctionScreen: {
      ...
      subtitle: "Покупайте и Продавайте с Миром • Публикация за $0.10",
      chatHall: "Чат-Зал",
      ...
      whatsapp: "WhatsApp",
      cancel: "Отмена",
      postListingCost: "Опубликовать - $0.10",
      posting: "Публикация...",
  ...
  pt: {
    ...
    auctionScreen: {
      ...
      subtitle: "Compre e Venda com o Mundo • Publique por $0.10",
      chatHall: "Sala de Chat",
      ...
      whatsapp: "WhatsApp",
      cancel: "Cancelar",
      postListingCost: "Publicar Anúncio - $0.10",
      posting: "Publicando...",
  ...
  hi: {
    ...
    auctionScreen: {
      ...
      subtitle: "दुनिया के साथ खरीदें और बेचें • $0.10 में पोस्ट करें",
      chatHall: "चैट हॉल",
      ...
      whatsapp: "WhatsApp",
      cancel: "रद्द करें",
      postListingCost: "लिस्टिंग पोस्ट करें - $0.10",
  ...
  th: {
    ...
    auctionScreen: {
      ...
      subtitle: "ซื้อและขายกับโลก • โพสต์ราคา $0.10",
      chatHall: "ห้องแชท",
      ...
      whatsapp: "WhatsApp",
      cancel: "ยกเลิก",
      postListingCost: "โพสต์ประกาศ - $0.10",
      posting: "กำลังโพสต์...",
  ...
  vi: {
    ...
    auctionScreen: {
      ...
      subtitle: "Mua & Bán với Thế Giới • Đăng chỉ với $0.10",
      chatHall: "Phòng Chat",
